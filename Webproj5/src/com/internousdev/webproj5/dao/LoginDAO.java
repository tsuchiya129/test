...
public class LoginDAO {
	...
	public List<LoginDTO>select(String username,String password){
		...
		try{
			...
			/**
			 * executeQuery=SQL文の実行文,
			 * ResultSet=コマンドプロンプトselect入力すると表になる部分
			 */
			...
			/**
			 * 入力されたname、passwordとデータベースに入っているname、passwordがあっているかwhile文で確認してくれ
			 * loginDTOList=DTOでここにまとめた情報を今度は全部１つにまとめてもの
			 */
			...
			/**
			 *loginDTOListの中が空っぽなら"該当なし"を表示してくれ
			 */
